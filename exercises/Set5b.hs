...
set _ _ Empty = Empty
set [] val (Node v sub1 sub2) = Node val sub1 sub2
set (StepL:steps) val (Node v sub1 sub2) = Node v (set steps val sub1) sub2
set (StepR:steps) val (Node v sub1 sub2) = Node v sub1 (set steps val sub2)
