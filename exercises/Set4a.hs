...
incrementKey k = map (\(k1, v1) -> if k == k1 then (k1, v1 + 1) else (k1, v1))
...
winner scores player1 player2 =
  let player1Points = Map.findWithDefault 0 player1 scores
      player2Points = Map.findWithDefault 0 player2 scores
  in  if player1Points >= player2Points then player1 else player2
